...
const String LOGO_PREFIX_PATH = "https://cdn.certquestionbank.com/"; //where to store logo
...
const Map<String, List<String>> CATEGORY_GROUPS = {
  ...
  "Azure": ["AZ_AI_901", "AZ_DP_900", "AZ_DP_300", "AZ_AZ_900", "AZ_AZ_700", "AZ_SA_305", "AZ_AZ_400"],
...
const String LANDING_URL_PREFIX = "https://certquestionbank.com/detail/"; //where to store logo
